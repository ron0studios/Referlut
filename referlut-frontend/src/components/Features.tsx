...
const features = [
  ...
  },
  {
    ...
    description:
      "Borrow Costco, Pret, and other memberships from people near you for maximum savings.",
  },
  {
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Referlut combines the power of community sharing and AI to help you
            save money in ways you never thought possible.
          </p>
        </div>
