        ...
        <div className="bg-gradient-to-r from-referlut-purple to-referlut-light-purple rounded-3xl overflow-hidden">
          <div className="flex flex-col md:flex-row">
            <div className="md:w-3/5 p-8 md:p-12">
              <h2 className="text-3xl font-bold text-white mb-6">Start Saving Money Today</h2>
              <p className="text-white/90 text-lg mb-8 max-w-lg">
                Join thousands of students already using Referlut to save money, share memberships, and discover the best deals. It only takes a minute to get started.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <Link to="/signup">
                  <Button size="lg" className="bg-white text-referlut-purple hover:bg-white/90">
                    Create Free Account
                  </Button>
                </Link>
                <Link to="/login">
              ...
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-xl shadow-lg p-6 w-64">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center space-x-2">
                    <div className="h-8 w-8 rounded-full bg-referlut-orange/20 flex items-center justify-center text-referlut-orange font-semibold">£</div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-gray-600">Shared Memberships</span>
