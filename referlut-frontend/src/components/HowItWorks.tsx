...
const steps = [
  ...
  },
  {
    ...
    description:
      "Find and connect with people to exchange referral codes or share memberships.",
  },
  {
    number: "03",
  ...
  },
  {
    ...
    title: "Save and Earn",
    description:
      "Start saving money and earning rewards through shared referrals and memberships.",
  },
];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            ...
            and sharing benefits with others.
          </p>
        </div>
          ...
          {steps.map((step, index) => (
            <div key={index} className="relative">
              <div className="bg-referlut-blue/10 rounded-xl p-6 h-full">
                <div className="text-3xl font-bold text-referlut-purple mb-4">
                  {step.number}
                </div>
        ...
        <div className="bg-gradient-to-r from-referlut-purple to-referlut-light-purple rounded-2xl p-8 text-white text-center">
          ...
          <p className="mb-6 max-w-lg mx-auto">
            Join thousands of students already using Referlut to save money and
            earn rewards.
          </p>
          <Link to="/signup">
            <Button
              size="lg"
              className="bg-referlut-orange hover:bg-referlut-orange/90 text-white border-none"
            >
              Create Free Account
            </Button>
          </Link>
