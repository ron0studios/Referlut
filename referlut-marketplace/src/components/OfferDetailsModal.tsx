      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl transform transition-all animate-fade-in">
        ...
        <div className="p-6">
          <div className="flex items-center mb-6">
            ...
            />
            <div>
              <h3 className="text-xl font-semibold text-gray-800">{offer.brand}</h3>
              <p className="text-gray-600">{offer.type.charAt(0).toUpperCase() + offer.type.slice(1)} Offer</p>
            </div>
          </div>
          ...
          <div className="space-y-6">
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                {offer.type === 'loyalty' && (
                  <ol className="list-decimal list-inside space-y-2">
                    <li>Pay your share (£{offer.price}) to join the loyalty card pool</li>
                    <li>Get access to the shared loyalty card details</li>
                    <li>Use the card to enjoy discounts and benefits</li>
                    <li>Follow the usage schedule shared by the card owner</li>
                  </ol>
                )}
                {offer.type === 'referral' && (
                  <ol className="list-decimal list-inside space-y-2">
                    ...
                    <li>Complete any required actions to qualify for the reward</li>
                  </ol>
                )}
                {offer.type === 'charity' && (
                  <ol className="list-decimal list-inside space-y-2">
            ...
            <div>
              <h4 className="text-lg font-semibold mb-2">Current Participants</h4>
              <div className="flex -space-x-2">
                ...
                {offer.total - offer.used > 0 && (
                  <div className="w-8 h-8 rounded-full bg-blue-100 border-2 border-white flex items-center justify-center">
                    <span className="text-xs font-medium text-blue-600">+{offer.total - offer.used}</span>
                  </div>
                )}
              </div>
            </div>
        ...
        <div className="border-t p-6 flex justify-between items-center">
          <div>
            ...
            <p className="text-lg font-semibold">{offer.total - offer.used} of {offer.total}</p>
          </div>
