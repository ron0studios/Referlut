...
export const mockOffers: Offer[] = [
  {
    ...
    description: 'Share a Costa Coffee loyalty card and save on your favorite drinks.',
    used: 3,
    total: 5,
    price: 10,
  ...
  },
  {
    ...
    description: 'Share a Costco membership and split the annual fee.',
    used: 1,
    total: 3,
    price: 2,
  ...
  },
  {
    ...
    description: 'Join our Pret Coffee Subscription and enjoy unlimited coffee.',
    used: 0,
    total: 1,
    price: 0,
    featured: true,
  ...
  },
  {
    ...
    brand: 'Generic',
    type: 'loyalty',
    title: 'Movie Club Card',
    description: 'Share a movie club subscription for discounted tickets.',
    used: 3,
    total: 4,
    price: 5,
